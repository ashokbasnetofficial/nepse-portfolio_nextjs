        ...
        <form className="flex items-center max-w-sm mx-auto mt-10 mb-10">
            ...
            <div className="relative w-full">
                ...
                <input
                    type="text"
                    id="simple-search"
                    className="w-full px-4 py-2 bg-transparent border border-green-300 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-transparent"
