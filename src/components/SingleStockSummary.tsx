...
const SingleStockSummary = () => {
  return (
    <Card>
      <div className='flex flex-row items-center bg-green-400 justify-between px-4 py-4 uppercase rounded-lg'>
    ...
    <p className='flex flex-row items-center text-sm sm:text-base md:text-lg'>
        ltp: <span className='bg-green-600 rounded-sm text-white font-bold'>358.5</span>
    </p>
    <p className='flex flex-row items-center text-sm sm:text-base md:text-lg space-x-2 sm:space-x-4 md:space-x-6'>
        ch: <span className='bg-green-600 rounded-sm  text-white font-bold'>+14.5</span> 
        <span className='bg-green-600 rounded-sm text-white font-bold'>+3.89%</span>
    </p>
</div>
