      ...
      <div className="grid gap-4 my-4 px-3">
        ...
        <div className="flex flex-row md:items-center justify-between">
          <p className="text-sm md:text-base">
            Current Investment:{" "}
            <span className="font-bold text-sm md:text-base">Rs 3952</span>
          </p>
          <p className=" text-sm md:text-base">
            Profit: <span className="font-bold text-sm md:text-base">16%</span>
          </p>
        </div>
        <div className="flex flex-row md:items-center justify-between">
          <p className="text-sm md:text-base">
          ...
          <p className="text-sm md:text-base">
            Unreal Gain:{" "}
            <span className="font-bold text-sm md:text-base">16%</span>
          </p>
        </div>
      </div>
      <p className="text-center text-sm md:text-base pb-2">
        Receiveable Amount:{" "}
        <span className="font-bold text-sm md:text-base">Rs 6545</span>
      </p>
    </>
  );
};
