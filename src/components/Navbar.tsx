    ...
    <nav className="bg-gradient-to-r from-blue-800 to-blue-600 text-white p-4 sm:p-6 md:flex md:justify-between md:items-center">
      <div className="container mx-auto flex justify-between items-center">
        <a href="/" className="flex space-x-1 items-center">
          ...
          <p className="text-white font-bold tracking-wide text-xl pl-2">
            Mero<span className="text-bright-red">Portfolio</span>
          </p>
        </a>
        <div
          className={`menu ${
            isOpen ? "open" : ""
          } md:relative md:left-auto md:top-auto md:flex md:flex-row md:items-center md:bg-transparent md:w-auto`}
        >
          ...
          <Link href="/login" className="btn-primary  md:mt-2 md:ml-4">
            Login
          </Link>
        </div>
