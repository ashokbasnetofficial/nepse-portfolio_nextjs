  ...
  return (
    <form className="text-black max-w-md" onSubmit={formSubmitHandler}>
      <div className="form-group mb-2">
        <label htmlFor="share_Quantity" className="block mb-2">
          Share Quantity
        </label>
        <input
          type="number"
      ...
      <div className="form-group mb-2">
        <label htmlFor="purchase_Price" className="block mb-2">
          Purchase Price
        </label>
        <input
          type="number"
      ...
      <div className="form-group mb-2">
        <label htmlFor="selling_Price" className="block mb-2">
          Selling Price
        </label>
        <input
          type="number"
      ...
      <div className="form-group mb-2">
        <label htmlFor="invest_Type" className="block mb-2">
          Investor Type
        </label>
        <select
          name="invest_Type"
      ...
      <div className="form-group mb-2">
        <label htmlFor="capital_gain_tax" className="block mb-2">
          Capital Gain Tax
        </label>
        <select
          name="capital_gain_tax"
        ...
        >
          ...
          {investorType === "Institutional" && <option value="10">10%</option>}
        </select>
      </div>
      <div>
        <button
